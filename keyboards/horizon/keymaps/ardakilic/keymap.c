...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_SCRL, KC_MS_BTN2,_______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
    ...
    [_NUMPAD] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_SCRL, KC_MS_BTN2, KC_BSPC,  KC_P0, KC_P0, KC_SLSH, KC_PDOT, KC_PEQL
    ),
};