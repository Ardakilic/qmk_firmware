 ...
 * |------+------+------+------+------+------+------|       |------+------+------+------+------+------+------|
 * |NPdEsc|   A  |   S  |   D  |   F  |   G  | LCbr |       | RCbr |   H  |   J  |   K  |   L  |   Ş  |  İ   |
 * |------+------+------+------+------+------+------|       |------+------+------+------+------+------+------|
 * |SftCps|   Z  |   X  |   C  |   V  |   B  |Space*|       |Space*|   N  |   M  |   Ö  |   Ç  |   .  |SftEtr|
 * |------+------+------+------+------+------+------|       |------+------+------+------+------+------+------|
 * ||Ctrl | Alt  |  OS  |Sda|<>|  Lower|,  | Space* |       |Space*  |  "|Raise  | Left | Down |  Up  |Right |
 * `------------------------------------------------'       `------------------------------------------------'
 */

  [_QWERTY] = LAYOUT(
    KC_TAB, KC_Q,KC_W, KC_E, KC_R, KC_T, KC_LBRC,                   /*|*/         KC_RBRC, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
    LT(_NUMPAD, KC_ESC),KC_A,KC_S,KC_D,KC_F,KC_G,KC_LCBR,           /*|*/         KC_RCBR, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
    LSFT_T(KC_CAPS),KC_Z,KC_X,KC_C,KC_V,KC_B,LT(_SPACE, KC_SPC),    /*|*/         LT(_SPACE, KC_SPC), KC_N,  KC_M,  KC_COMM, KC_DOT, KC_SLSH, KC_SFTENT,
    KC_LCTL, KC_LALT, KC_LGUI, LT(_SODA, KC_GRV),LT(_LOWER, KC_BSLS),LT(_SPACE, KC_SPC),    /*|*/       LT(_SPACE, KC_SPC), LT(_RAISE, KC_NONUS_BSLASH), KC_LEFT, KC_UP, KC_DOWN, KC_RGHT
  ),
 ...
 * |------+------+------+------+------+------+------|       |------+------+------+------+------+------+------|
 * |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 | Bksp |       | Bksp |      |  "$" |  "{" |  "}" |  <   |  ">" |
 * |------+------+------+------+------+------+------|       |------+------+------+------+------+------+------|
 * |      |      |      |      |           |   Bksp |       | Bksp   |           |      |      |      |      |
 * `------------------------------------------------'       `------------------------------------------------'
 */
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BSPC,   /*|*/        KC_BSPC, _______,DOLLAR_SIGN, CURLY_OPEN, CURLY_CLOSE, KC_GRV, LSFT(KC_GRV),
 ...
 */
  [_SODA] = LAYOUT(
    _______, _______, KC_UP, _______, KC_BRMU, _______, _______,      /*|*/       _______, _______, _______, _______, _______, _______, LOCKSCREEN,
    _______, KC_LEFT, KC_DOWN, KC_RGHT,KC_BRMD, _______, _______,     /*|*/       _______, _______, _______, _______, _______, _______, _______,
