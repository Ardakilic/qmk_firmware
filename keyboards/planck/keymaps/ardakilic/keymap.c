...
[_LOWER] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______,      KC_ENT,      _______,   SQUARE_OPEN, SQUARE_CLOSE, LSFT(KC_2), KC_NONUS_BSLASH
),
...
[_RAISE] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______,      KC_BSPC,     _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
