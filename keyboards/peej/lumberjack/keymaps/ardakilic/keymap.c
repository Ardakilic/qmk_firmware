 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |SftCps|  Z   |  X   |  C   |  V   |  B   | |  N   |  M   |  Ö   |  Ç   |  .   | Entr |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * | Ctrl |Adj|<>| Win  | Alt  |Lowr|,| Spc* | | Spc* | AltGR| Left | Down |  Up  | Rght |
 * `-----------------------------------------' `-----------------------------------------'
 */
...
[_LOWER] = LAYOUT_ortho_5x12(
    ...
    _______,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,             /*|*/   _______,NUMBER_SIGN,KC_NUBS,RALT(KC_LBRC),RALT(KC_RBRC),_______,
    _______,KC_F11,KC_F12,_______,_______,_______,      /*|*/   _______,KC_UNDS,KC_PLUS,KC_LBRC,KC_RBRC,KC_EQL,
